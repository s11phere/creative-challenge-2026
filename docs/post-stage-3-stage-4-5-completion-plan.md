...
**当前记录**：现有 Web 单元/组件测试与生产构建已通过，隔离 Web 同源烟测已通过，详见
[`stage-4-5-step4-web-e2e.md`](stage-4-5-step4-web-e2e.md)。由于仓库和环境均无 Playwright/
浏览器，桌面移动截图、真实键盘旅程和浏览器级重连尚未验收；本步骤保持 provisional。
